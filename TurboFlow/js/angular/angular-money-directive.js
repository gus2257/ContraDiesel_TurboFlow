    ...
    .directive('money', function() {
        ...
        function link(scope, el, attrs, ngModelCtrl) {
            ...
            function addGroupSeparators(numberStr, decimals) {
                ...
                var Resultado = integerPart + decimalPart;
                var ValidaRes = integerPart + decimalPart;

                var TComas = ValidaRes.split(",");
                    for (var index = 0; index < TComas.length; index++) {

                        ValidaRes = ValidaRes.toString().replace(",", "");

                    }

                    if (ValidaRes.toString().length > 10) {
                        Resultado = "";
                    }
                
                return Resultado; //integerPart + decimalPart;
            }
